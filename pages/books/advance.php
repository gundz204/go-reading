  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="stories-container">
        ...
        // Query untuk mengambil data buku dari kategori 'advance' saja
        $query = "SELECT id, title, image_url FROM books WHERE category = 'advance'";
        $result = $conn->query($query);
    
        // Periksa jika terdapat data
        if ($result->num_rows > 0) {
            // Loop untuk menampilkan setiap buku dari kategori 'advance'
            ...
            echo '<p>No books found in the advance category.</p>';
        }
