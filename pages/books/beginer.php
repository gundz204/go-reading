  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="stories-container">
        ...
        // Query untuk mengambil data buku dari kategori 'beginner' saja
        $query = "SELECT id, title, image_url FROM books WHERE category = 'beginner'";
        $result = $conn->query($query);
    
        // Periksa jika terdapat data
        if ($result->num_rows > 0) {
            // Loop untuk menampilkan setiap buku dari kategori 'beginner'
            ...
            echo '<p>No books found in the beginner category.</p>';
        }
